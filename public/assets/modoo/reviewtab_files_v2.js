...
<ul class="com_infor" style="display:inline-block;">
	<li>
	<div class="">
	<span class="">- 제공서비스</span>
	<div class="">
		<span class="high_option">가정이사</span> <span class="high_option">사무실이사</span>
	</div>
	</div>
	</li>
	<li>- 경력 : <b>00년 이상</b></li>
	<li>- 직원 수 : <b>1-10명</b> </li>
	<li>
	<div class="">
	<span class="">- 결제 수단</span>
	<div class="">
		<span class="high_option">현금</span> <span class="high_option">현금영수증</span>
	</div>
	</div>
	</li>
	<li>- 계좌번호 :  <b>우리 1000-0000-0000 예금주</b></li>
</ul>
