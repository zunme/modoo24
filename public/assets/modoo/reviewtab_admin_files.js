...
$('document').ready( function() {
  ...
  */
  ...
  $.ajax({
    url : '/community/api/review/files/'+ s_uid,
    method:'get',
    dataType:'JSON',
...
function reviews(){
  ...
  $.ajax({
    url : '/community/api/review/staff/'+ s_uid,
    method:'get',
    dataType:'JSON',
...
{{#if data.length}}
  ...
  <div class="move_content">
    ...
    <div class="review_img">
        <div class="d-flex">
          {{#each files}}
            <div class="four_img pic01" style="background-image:url(/community/storage{{url}})"><a href="/community/storage{{url}}" data-lightbox="image-r-{{review_id}}"
