...
<section id="banner_visual">
    <ul>
        <li>
            <a class="pc" href="javascript:openpopcontact();"><img src="/v1/image/main_N/main_bn02.png"></a>
            <a class="mobile" href="javascript:openpopcontact();"><img src="/v1/image/main_N/main_m_bn02.png"></a>
        ...
        <li class="pc">
            <a href="javascript:openpopclean();"><img src="/v1/image/main_N/main_bn03.png"></a>
        </li>
        <li class="pc">
            <a href="javascript:openpopAi();">
    ...
    <div class="row" style="display:none">
        ...
        <div class="col-md-4 col-sm-6 pc"><a href="javascript:openpopclean();"><img src="/v1/image/main_N/main_bn03.png"></a></div>
...
@include('Front.Poporder.popcontactorder')
@include('Front.Poporder.popclean')
<!-- /nface ai pop -->
