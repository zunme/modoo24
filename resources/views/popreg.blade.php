...
:root {
  ...
  */
  ...
  --pop-stepper-no : 4; /*stepper 갯수*/
  --pop-footer-height:0px; /* pop-footer-navbar 높이 */
...
.pop-page-content {
    ...
    position: relative;
    z-index: 1;
    padding-top: calc( var(--pop-footer-height) +  var(--pop-page-content-addition-height) + var(--navbar-stepper-height) + 44px );
    padding-bottom: 10px;
}
.pop-page-section{
